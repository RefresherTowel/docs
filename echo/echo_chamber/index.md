...
var _win = new EchoChamberWindow("test_window")
	.SetTitle("Test window");

var _toolbar_panel = new EchoChamberPanel("toolbar_panel", eEchoChamberDock.FILL)
...
_toolbar_panel.AddControl(_ctrl_btn);
_win.AddPanel(_toolbar_panel);
_win.FitToContent(_root);
_root.RegisterWindow(_win);
```
