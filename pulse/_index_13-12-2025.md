...
- **Bug reports / feature requests**  
 The best place to report bugs and request features is the GitHub Issues page:
  ...
  [**Pulse issues**](https://github.com/RefresherTowel/Pulse/issues)
  ...
  If you are not comfortable using GitHub, you can also post in [**the Pulse discord channel**](https://discord.gg/8spFZdyvkb) and I can file an issue for you.
