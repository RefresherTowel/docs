...
![Echo icon]({{ '/assets/echo_icon.png' | relative_url }})
{: .text-center}
...
> [!Echo Chamber UI development]({{ '/assets/echo_chamber_promo.gif' | relative_url }})
> And here is the implementation of [**Statements**]({{ '/archive/statement/1.3.7/index.md' | relative_url }}) Lens visual debugger, written entirely with Echo Chamber:
> [!Statement Lens debugger]({{ '/assets/statement_lens_marketing.gif' | relative_url }})
{: .bonus}
---
...
![Statement Lens]({{ '/assets/statement_lens_marketing.gif' | relative_url }})
