...
> If you plan to create and manage your own root, set `ECHO_CONSOLE_ENABLED` to 0 in `scr_echo.gml` so Echo does not auto create a second root.
{: .warning}
