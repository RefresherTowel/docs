...
![Statement icon]({{ '/assets/statement_icon.png' | relative_url }})
{: .text-center}
...
> Statement ships with [**Echo**]({{ '/archive/echo/2.3.1/' | relative_url }}) (a minimalist, yet powerful, debug logging framework) for free!
> {: .important}
