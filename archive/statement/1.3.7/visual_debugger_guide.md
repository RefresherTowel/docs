...
parent: Statement v1.3.7
nav_order: 3
nav_exclude: true
search_exclude: true
doc_library: statement
doc_version: "1.3.7"
---
<!--
...
![Statement Visual Debugger in action!]({{ '/assets/visual_debugger_guide/statement_visual_debugger_showoff.gif' | relative_url }})
...
![Visual Debugger interface]({{ '/assets/visual_debugger_guide/visual_debugger.png' | relative_url }})
...
![Inspector panel]({{ '/assets/visual_debugger_guide/righthand_panel.png' | relative_url }})
...
![Nodes and edges]({{ '/assets/visual_debugger_guide/nodes_and_edges.png' | relative_url }})
...
![Controlling states]({{ '/assets/visual_debugger_guide/visual_debugger_interact.gif' | relative_url }})
...
![Radial layout]({{ '/assets/visual_debugger_guide/statement_radial.png' | relative_url }})
...
![Layout Full mode]({{ '/assets/visual_debugger_guide/layout_full_mode.png' | relative_url }})
...
![Layout Radial mode]({{ '/assets/visual_debugger_guide/layout_radial_mode.png' | relative_url }})
...
![Layout Cloud mode]({{ '/assets/visual_debugger_guide/layout_cloud_mode.png' | relative_url }})
...
![Layout Ego mode]({{ '/assets/visual_debugger_guide/layout_ego_mode.png' | relative_url }})
